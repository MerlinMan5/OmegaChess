export const CARD_META = {
  ...
  PAWN_RUSH:      { emoji: '🏃', name: 'Pawn Rush',           desc: 'All pawns can advance 2 squares.' },
  SWAP_PLACES:    { emoji: '🔄', name: 'Swap Places',         desc: 'Swap any two of your non-king pieces.' },
  SHIELD_WALL:    { emoji: '🛡️', name: 'Shield Wall',         desc: 'Your pieces are immune to card-effect destruction.' },
  COPYCAT:        { emoji: '🪞', name: 'Copycat',             desc: "Play the same card your opponent just played." },
};
